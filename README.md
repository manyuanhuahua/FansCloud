...
* Request
  * Method: POST
  * URL: /user/current/albums/:albumId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: /user/current/comments/:commentId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /user/current/playlists/:id/songs
  * Headers:
    * Content-Type: application/json
  * Body:
