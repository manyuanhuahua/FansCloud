...
* Request
  * Method: GET
  * URL: /api/session/currentUser/songs
  * Body: none
...
* Request
  * Method: GET
  * URL: /api/session/currentUser/albums
  * Body: none
...
* Request
  * Method: POST
  * URL: /api/songs/:songId/comments/new
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /api/session/currentUser/playlists
  * Body: none
